        ...
        <div className="grid md:grid-cols-3 gap-8">
          {missions.map((mission, index) => (
            <motion.div
              ...
              className="group"
            >
              <Card className="bg-white border-black hover:border-yellow-400 transition-all duration-300 h-full">
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-2xl font-bold mb-4 text-black">{mission.title}</h3>
                  <p className="text-black leading-relaxed">{mission.description}</p>
                </CardContent>
              </Card>
            </motion.div>
          ))}
